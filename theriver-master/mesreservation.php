                    ...
                    <div class="booking_form_container">
                        <div class="d-flex flex-xl-row flex-column align-items-start justify-content-center">
                            <div class="booking_input_container d-flex flex-row align-items-start justify-content-center flex-wrap">
                                ...
                                <div><a href="mesreservation.php"><button class="booking_button trans_200">Chercher un autre</button></a></div>
                            </div>
                        </div>
                    </div>
                <?php
            ...
            <div class="splide__track">
              <ul class="splide__list">
                ...
                <main class="main-content">
                  ...
                  <div class="flex-row">
                    <div class="coin-base">
                      <img src=<?php echo "logo/".$unequipement['logo'] ?> alt="logo de l'équipement" class="medium-image"/>
